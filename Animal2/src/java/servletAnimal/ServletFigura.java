...
public class ServletFigura extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if("c".equals(request.getParameter("tipo"))) {
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletAnimal</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>nombre "+ani.getArea()+"</h1>");
            out.println("<h1>comida "+ani.getPerimetro()+"</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
